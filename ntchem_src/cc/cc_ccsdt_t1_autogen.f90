      SUBROUTINE CC_CCSDT_T1_AutoGen
!
...
!----- V1 += T1(221)*V2
      ...
      mAn = CCLib_NComb(NVr, nAn)
      mIn = CCLib_NComb(NOc, nIn)
      CALL CC_Contract_Ao00Io00At01It01J01B01S_AutoGen( &
      &   V2, T, V1, nAo, nIo, nAt, nIt, nB, nJ, mCK, mB, mJ, mAo, mIo, mD, mL, mAn, mIn)
      DEALLOCATE( T)
      DEALLOCATE( V2)
      CALL CC_WriteV( NSizeV1, V1, 'V1')
...
!----- V1 += T1(231)*V2
      ...
      mAn = CCLib_NComb(NVr, nAn)
      mIn = CCLib_NComb(NOc, nIn)
      CALL CC_Contract_Ao00Io01At01It00J02B01S_AutoGen( &
      &   V2, T, V1, nAo, nIo, nAt, nIt, nB, nJ, mCK, mB, mJ, mAo, mIo, mD, mL, mAn, mIn)
      DEALLOCATE( T)
      DEALLOCATE( V2)
      CALL CC_WriteV( NSizeV1, V1, 'V1')
...
!----- V1 += T1(232)*V2
      ...
      mAn = CCLib_NComb(NVr, nAn)
      mIn = CCLib_NComb(NOc, nIn)
      CALL CC_Contract_Ao01Io00At00It01J01B02S_AutoGen( &
      &   V2, T, V1, nAo, nIo, nAt, nIt, nB, nJ, mCK, mB, mJ, mAo, mIo, mD, mL, mAn, mIn)
      DEALLOCATE( T)
      DEALLOCATE( V2)
      CALL CC_WriteV( NSizeV1, V1, 'V1')
...
!----- V1 += T1(342)*V2
      ...
      mAn = CCLib_NComb(NVr, nAn)
      mIn = CCLib_NComb(NOc, nIn)
      CALL CC_Contract_Ao00Io00At01It01J02B02S_AutoGen( &
      &   V2, T, V1, nAo, nIo, nAt, nIt, nB, nJ, mCK, mB, mJ, mAo, mIo, mD, mL, mAn, mIn)
      DEALLOCATE( T)
      DEALLOCATE( V2)
      CALL CC_WriteV( NSizeV1, V1, 'V1')
