      SUBROUTINE  CC_ContractGEMM_Ao00Io01At04It03S_AutoGen &
...
!
            DO iAt00 =  4, NVr   ! loop over external particle(s) in V
               NStringAt( 4) = iAt00
               IAddAt00 = 1 + IArcWgtVir(iAt00,  4, nAt)
            DO  iAt01 =  3, iAt00 - 1
               NStringAt( 3) =  iAt01
               IAddAt01 = IAddAt00 + IArcWgtVir(iAt01,  3, nAt)
            DO  iAt02 =  2, iAt01 - 1
               NStringAt( 2) =  iAt02
               IAddAt02 = IAddAt01 + IArcWgtVir(iAt02,  2, nAt)
            DO  iAt03 =  1, iAt02 - 1
               NStringAt( 1) =  iAt03
               IAddAt03 = IAddAt02 + IArcWgtVir(iAt03,  1, nAt)
               IAddAt = IAddAt03
               ISgnAn = 1
               IAddAn = IAddAt
!
